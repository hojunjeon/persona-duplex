...
rem Examples: persona-duplex.bat mock | persona-duplex.bat accuracy
set "PERSONA_MODE=%~1"
...
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0persona-duplex.ps1" run "%PERSONA_MODE%"
